...
import bootsample.FileUploadController;
...
public class MainController {
	...
	public String oneTask(@RequestParam int id,HttpServletRequest request){
	...
	@GetMapping("/new-task")
	public String newTask(HttpServletRequest request, Model model)throws IOException{
	...
	public String saveTask(@ModelAttribute Task task, BindingResult bindingResult, HttpServletRequest request, @RequestParam("file") MultipartFile file,
        ...
        task.setFile("https://drive.google.com/open?id="+f.getId());
        request.setAttribute("tasks", taskService.findAll());
		request.setAttribute("mode", "MODE_TASKS");
		return "index";
	}
